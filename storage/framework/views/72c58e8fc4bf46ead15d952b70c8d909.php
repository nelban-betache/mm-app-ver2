...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="<?php echo e(asset('assets/images/blood.jpg')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('assets/auth/css/styles.min.css')); ?>" />

    <link rel="stylesheet" href="<?php echo e(asset('assets/izitoast/iziToast.min.css')); ?>">
...
<body style="background-color: #FFD6D1;">
                        ...
                        <div class="card mb-0">
                            <div class="card-body floating-shadow">
                                <div class="d-flex align-items-center justify-content-center">
                                    <img style="width: 200px" class="img-fluid" alt="logo" src="<?php echo e(asset('assets/images/blood.jpg')); ?>" />
                                </div>
                                <br>
                                <div>
                                ...
                                <?php if(Route::has('login')): ?>
                                    ...
                                    <?php if(auth()->guard()->check()): ?>
                                        <?php if(Auth::user()->user_role_id == 1): ?>
                                            ...
                                            <a href="<?php echo e(URL::to('admin/dashboard')); ?>" class="btn btn-primary w-100 py-2 fs-4 rounded-1">Return to Dashboard</a>
                                        <?php elseif(Auth::user()->user_role_id == 3): ?>
                                            <p class="text-center mb-4">Leaving already? click below to return to dashboard</p>
                                            <a href="<?php echo e(URL::to('health-worker/dashboard')); ?>" class="btn btn-primary w-100 py-2 fs-4 rounded-1">Return to Dashboard</a>
                                        <?php else: ?>
                                            <p class="text-center mb-4">Leaving already? click below to return to dashboard</p>
                                            <a href="<?php echo e(URL::to('user/dashboard')); ?>" class="btn btn-primary w-100 py-2 fs-4 rounded-1">Return to Dashboard</a>
                                        <?php endif; ?>
                                    <?php else: ?>
                                        ...
                                        <form method="POST" action="<?php echo e(route('login')); ?>" autocomplete="off">
                                            ...
                                            <div class="mb-3" id="emailInput">
                                                ...
                                                <input type="email" id="email" name="email" class="form-control <?php echo e($errors->has('email') ? 'is-invalid' : ''); ?>" value="<?php echo e(old('email')); ?>" placeholder="Enter email ex: juany@sample.com" required autofocus>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="input-group">
                                                    <input type="password" id="password" name="password" class="form-control <?php echo e($errors->has('password') ? 'is-invalid' : ''); ?>" placeholder="•••••••" required>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-4">
                                                <div class="form-check">
                                                    <input class="form-check-input primary" type="checkbox" id="remember" name="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-3">
                                                <?php if(Route::has('register')): ?>
                                                    <a class="text-primary fw-bold" href="<?php echo e(route('register')); ?>">Register an Account</a>
                                                <?php endif; ?>
                                                <a class="text-primary fw-bold" href="<?php echo e(URL::to('forgot-password')); ?>">Forgot Password</a>
                                            </div>
                                        </form>
                                    <?php endif; ?>
                                <?php endif; ?>
    ...
    <script src="<?php echo e(asset('assets/auth/libs/jquery/dist/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/auth/libs/bootstrap/dist/js/bootstrap.bundle.min.js')); ?>"></script>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <?php echo $__env->make('auth.response', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</body>
</html><?php /**PATH C:\xamp\htdocs\mm-app-v2-main\resources\views/auth/login.blade.php ENDPATH**/ ?>